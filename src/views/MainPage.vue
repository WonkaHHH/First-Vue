...
<el-row justify="center" align="center">
  ...
  <el-dialog v-model="runVisible" title="运行" :modal="false" :close-on-click-modal="false" :z-index="998" draggable>
  </el-dialog>
...
export default {
  setup() {
    ...
    return { goToHomePage, runVisible, bagVisible, setVisible };
  },
};
</script>
