...
<!--  border-color: transparent;-->
<!--  color: white;-->
<!--  width: 20vw; /* 使用 vw 使按钮宽度根据视口宽度自动调整 */-->
<!--  height: 12vh; /* 使用 vh 使按钮高度根据视口高度自动调整 */-->
<!--  font-size: 2vw; /* 字体大小根据视口宽度自动调整 */-->
<!--  display: flex; /* 使用 flexbox 布局 */-->
<!--  align-items: center; /* 垂直居中 */-->
<!--  justify-content: center; /* 水平居中 */-->
...
<!--.my-custom-dialog {-->
<!--  width: 30vw; /* 使用 vw 使对话框宽度根据视口宽度自动调整 */-->
<!--  height: 40vh; /* 使用 vh 使对话框高度根据视口高度自动调整 */-->
<!--  position: fixed; /* 固定定位 */-->
<!--  top: 10vh; /* 距离顶部 10% */-->
<!--  left: 35vw; /* 距离左侧 35% */-->
<!--  background-color: rgba(255, 255, 255, 0.6);-->
